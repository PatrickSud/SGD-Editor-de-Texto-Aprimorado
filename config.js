...
const DEFAULT_SETTINGS = {
  ...
  preferences: {
    ...
    enableClientInfo: true, // Lupa flutuante "Consulta Domínio Web" (client-info-service.js): consulta a API interna e mostra infos do cliente. Habilitado por padrão; getPrefs() trata ausência da chave como true.
    clientInfoAutoFetch: false, // Se true, a Consulta de Cliente busca sozinha ao detectar o clienteID na página; padrão false = só consulta ao clicar na lupa.
    clientInfoSimplified: true, // Modo de visualização da Consulta de Cliente: true = simplificado (padrão, esconde Jenkins/Tempo e encurta os valores), false = completo. Toggle "Simplificado" no cabeçalho do painel; getPrefs trata ausência como true.
