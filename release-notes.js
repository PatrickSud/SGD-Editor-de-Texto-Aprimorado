const RELEASE_NOTES = {
  '2.9.6': {
    ...
    features: [
      ...
      "<b>Atualização de Visuals e Feedback de Drag-and-Drop:</b> Melhorias visuais para listas de <b>saudações/encerramentos</b> durante operações de <b>arrastar e soltar</b>, incluindo áreas de <b>drop</b> mais claras e validação de itens.",
      "<b>⚡ Edição inline de categorias nos Trâmites Rápidos:</b> Permite editar, diretamente na toolbar dos Trâmites Rápidos, o nome das categorias.",
