...
const DEFAULT_FORMS_DATA = {
  categories: [
    ...
    {
      category: 'AI Chains - Apoio e Geral',
      items: [
        {
          type: 'link',
        ...
        },
        {
          ...
          description: 'Pesquisa Central por imagens e text',
    ...
    {
      category: 'AI Chains - Filas & Módulos',
      items: [
        {
          type: 'link',
    ...
    {
      category: 'AI Chains - Folha de Pagamento & DP',
      items: [
        {
          type: 'link',
    ...
    {
      category: 'AI Chains - Fiscal & Contabilidade',
      items: [
        {
          type: 'link',
    ...
    {
      category: 'AI Chains - Relatórios & Utilitários',
      items: [
        {
          type: 'link',
